...
const AuthButton = (props) => {
    if (isLoggedIn()) {
        return (
            <Fragment>
                <Link className="btn btn-dark btn-lg mt-3 ml-3 text-white" to="/logout">Logout</Link>
                <Link className="btn btn-dark btn-lg mt-3 ml-3 text-white" to="/">Home</Link>
                <Link className="btn btn-dark btn-lg mt-3 ml-3 text-white" to="/write">Write</Link>
            </Fragment>
        )
